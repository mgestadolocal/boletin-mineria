...
1. `scraper.py` — descarga pura vía HTTP (sin navegador): visita la portada del día en boletinoficialdemineria.cl, descubre qué categorías tienen contenido ese día (Pedimentos, Manifestaciones, Solicitudes/Oposición de Mensura, Sentencias de Exploración, Sentencias de Explotación), y descarga cada PDF directo desde diariooficial.interior.gob.cl.
